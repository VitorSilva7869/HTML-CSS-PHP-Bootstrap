        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 roxo-sinza">
                    <h2 class="bb_style txt_cent">login</h2><a href="cadastrar.php"><h2 class="h22_style">Cadastrar</h2></a>
                    <form class="">
                        
                        <div class="sigle-inputs centrodiv">
                            <input required type="text" class="input"  name="gmail" id="email"/>
                            <label for="Lembrar">Email</label>
                        </div>
                        <div class="sigle-inputs centrodiv">
                            <input required type="password" class="input" name="password1" id='password2' required /> <!-- Required obriga não estar vazio-->
                        ...
                        <div class="centrodiv">
                            ...
                            <button type="button" class="btn btn-outline-secondary transicao_color">Continuar</button>
                        </div>
